...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function proxy($grant_type, $credentials)
        {
                        /** @var \App\Services\UserService $instance */
                        return $instance->proxy($grant_type, $credentials);
        }
                    /**
         * Get List
         *
     ...
     */ 
        ...
        public static function queryResult($array = [])
        {
                        /** @var \App\Services\CourseService $instance */
                        return $instance->queryResult($array);
        }
                    /**
         * Get List
     ...
     */ 
        ...
        public static function queryResult($array = [])
        {
                        /** @var \App\Services\LessonService $instance */
                        return $instance->queryResult($array);
        }
                    /**
         * Get List
     ...
     */ 
        ...
        public static function queryResult($array = [])
        {
                        /** @var \App\Services\QuizService $instance */
                        return $instance->queryResult($array);
        }
                    /**
         * Get List
     ...
     */ 
        ...
        public static function queryResult($array = [])
        {
                        /** @var \App\Services\VideoService $instance */
                        return $instance->queryResult($array);
        }
                    /**
         * Get List
     ...
     */ 
        ...
        public static function queryResult($array = [])
        {
                        /** @var \App\Services\SubscriptionService $instance */
                        return $instance->queryResult($array);
        }
                    /**
         * Get List
     ...
     */ 
        ...
        public static function queryResult($array = [])
        {
                        /** @var \App\Services\CobonService $instance */
                        return $instance->queryResult($array);
        }
                    /**
         * Get List
...
namespace  { 
            ...
            class QuizFacade extends \App\Facades\Course\QuizFacade {}
            class VideoFacade extends \App\Facades\Course\VideoFacade {}
            class SubscriptionFacade extends \App\Facades\Subscription\SubscriptionFacade {}
            class CobonFacade extends \App\Facades\Subscription\CobonFacade {}
